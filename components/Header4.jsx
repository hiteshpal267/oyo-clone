...
const Header4 = () => {
  return (
    <div className="flex my-14 border-2 rounded-lg justify-between items-center  border-gray-300 px-5  ">
      ...
      <div className="flex">
        <input type="email" className="px-6 py-3 w-80 h-16 rounded-lg mr-5 outline-none border border-gray-300"
